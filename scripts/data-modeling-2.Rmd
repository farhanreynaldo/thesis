...
model_matrix_filenames <- list.files(
    ...
    pattern = "model_matrix_complete-\\d{4}-formula_level_4\\.rds",
    full.names = TRUE
  )
...
```{r}
# formula <- "yes | trials(yes + no) ~ z_inc*z_incstt + z_inc*z_trnprv + reg + age + 
#     (1 + z_inc | reg) + (1 + z_inc | stt) + (1 + z_inc | eth)  + (1 + z_inc | educ) + (1 + z_inc | age) + (1 + z_inc | metro) + (1 | inc) + (1 | reg : eth) + (1 | reg : inc) + (1 | reg : metro) + (1 | stt : eth) + (1 | stt : inc) + (1 | stt : metro) + (1 | eth : inc) + (1 | eth : metro) + (1 | inc : metro) + (1 | educ : stt) + (1 | educ : inc) + (1 | educ : eth) + (1 | educ : metro) + (1 | educ : metro : inc)"

formula <- "yes | trials(yes + no) ~ z_inc*z_incstt + z_inc*z_trnprv +
    (1 + z_inc | reg) + (1 + z_inc | stt) + (1 + z_inc | eth)  + (1 + z_inc | educ) + (1 + z_inc | age) + (1 + z_inc | metro) + (1 | inc) + (1 | reg : eth) + (1 | reg : inc) + (1 | reg : metro) + (1 | stt : eth) + (1 | stt : inc) + (1 | stt : metro) + (1 | eth : inc) + (1 | eth : metro) + (1 | inc : metro) + (1 | educ : stt) + (1 | educ : inc) + (1 | educ : eth) + (1 | educ : metro) + (1 | educ : metro : inc) + (1 | educ : eth : inc)"
